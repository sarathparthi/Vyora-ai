    ...
    <div className="min-h-screen bg-[#0B0F17] text-white flex items-center justify-center p-4 relative overflow-hidden selection:bg-blue-500 selection:text-white">
      ...
      <div className="w-full max-w-md space-y-6 relative z-10">
        <div className="text-center space-y-2">
          ...
          <p className="text-xs text-slate-400">Enter your registered email address to receive a password reset OTP code.</p>
        </div>
        ...
        <div className="flex items-center justify-center gap-2 text-[11px] text-slate-500">
          ...
          <span>OWASP Compliant Email Protection</span>
        </div>
      </div>
    </div>
  );
